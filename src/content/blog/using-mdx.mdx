...
Here is how you embed JSX inside of MDX. When you open this page in the
browser, you should see the styled button below.

<button
	style="font: inherit; padding: 0.4rem 0.8rem; border: 1px solid var(--accent); background: transparent; color: var(--accent); border-radius: 6px; cursor: pointer;"
