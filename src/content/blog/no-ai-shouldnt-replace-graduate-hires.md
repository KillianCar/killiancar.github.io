...
While it’s true that much of this entry-level work has gone away, what they haven't realised is that the difficulty in accomplishing most knowledge work has dropped due to AI, which means that tasks that previously required several years of experience can now be completed by… graduates. The floor has risen so that every employee can accomplish more than they could before, and increasingly challenging work is achieved lower in the chain.
